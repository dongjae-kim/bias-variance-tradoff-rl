% clear; clc;
function func_SIMUL_arbitration_regressor_generator_rpebl_kdj(in)
warning('off')
% in = 16;
...
TYPE_REGRESSOR=[1 1, 1.5 1.5, 1.5 1.5, 1.5 1.5, 1.5, 1.5, 1.5 1.5 1.5 1.5 1.5 1.5 1.5, 3 3 1.5 1.5 1.5 3 2 1.5 1.5 3 3 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5]; % 1: parametric modulation (0-duration), 1.5:parmetric modulation (non-zero duration), 1.7:parametric modulation (with decision onset)  2: extra continuous parametric modulation (TR-fixed) - this will be used by "dummy" regressor. 3 : IDK
...
switch in
    ...
    case 3% *** 23 11 7    
        ...
        reg_type_go_first=[1 1.5 2]; 
    case 4% *** 23 11 7    
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','RPE_BL'};        
        reg_type_go_first=[1 1.5 2]; 
    case 5% *** 23 11 7    
        param_regressor_type_cue={'SPE','RPE','invFanoM1','RPE_BL'};        
        reg_type_go_first=[1 1.5 2]; 
    case 6% *** 23 11 7    
        param_regressor_type_cue={'SPE','RPE','invFanoM2','RPE_BL'};        
        reg_type_go_first=[1 1.5 2]; 
    case 7% *** 23 11 7    
        param_regressor_type_cue={'SPE','RPE','weigtM1','RPE_BL'};        
        reg_type_go_first=[1 1.5 2]; 
    case 8% *** 23 11 7    
        param_regressor_type_cue={'SPE','RPE','weigtM2','RPE_BL'};        
        reg_type_go_first=[1 1.5 2]; 
    case 9% *** 23 11 7    
        param_regressor_type_cue={'SPE','RPE','Qfwd','RPE_BL'};        
        reg_type_go_first=[1 1.5 2]; 
    case 10% *** 23 11 7    
        param_regressor_type_cue={'SPE','RPE','Qsarsa','RPE_BL'};        
        reg_type_go_first=[1 1.5 2]; 
    case 11% *** 23 11 7    
        param_regressor_type_cue={'SPE','RPE','Qarb','RPE_BL'};        
        reg_type_go_first=[1 1.5 2]; 
end
