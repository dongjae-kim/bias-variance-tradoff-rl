...
%% subject parameter
EXP_NAME0='ANY_start_20_Sbj';
SUB_ARRAY=[0];
NUM_FILE_TO_PROCESS_FOR_EACH_SBJ=20; %  # of models to simulate for each subject.
model_id_to_process=2; % not using anymore
num_repeat_simulation=1; % # of repetition for each model.

% model start assumption
Force_FWD_start=0;
use_FWD_start_model=0; % 0: read all, 1: read fwd-start model only, 2: read sarsa-start model only
