function [data_out] = eval_ArbitrationRL_DPON3(param_in, data_in, mode)
    ...
    for ll=1:1:tot_num_sbj % each subject
        ...
        for kk=1:1:mode.total_simul
            ...
            if(mode.out==99)
                ...
                data_in{1,ll}.regressor{1,50}.name='MOTIV';     data_in{1,ll}.regressor{1,50}.value=[]; % max(invF1,invF2)  >> will be overwritten at the end for mean correction!
                data_in{1,ll}.regressor{1,50}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: motivation'};
                
                data_in{1,ll}.regressor{1,51}.name='SPEBL_LH';    data_in{1,ll}.regressor{1,51}.value=[];
                data_in{1,ll}.regressor{1,51}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: zspe lh'};
                data_in{1,ll}.regressor{1,52}.name='RPEBL_LH';    data_in{1,ll}.regressor{1,52}.value=[];
                data_in{1,ll}.regressor{1,52}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: zrpe lh'};
                
                data_in{1,ll}.regressor{1,53}.name='SPEBL_L';    data_in{1,ll}.regressor{1,53}.value=[];
                data_in{1,ll}.regressor{1,53}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: zspe l'};
                data_in{1,ll}.regressor{1,54}.name='SPEBL_H';    data_in{1,ll}.regressor{1,54}.value=[];
                data_in{1,ll}.regressor{1,54}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: zspe H'};
                data_in{1,ll}.regressor{1,55}.name='RPEBL_L';    data_in{1,ll}.regressor{1,55}.value=[];
                data_in{1,ll}.regressor{1,55}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: zrpe l'};
                data_in{1,ll}.regressor{1,56}.name='RPEBL_H';    data_in{1,ll}.regressor{1,56}.value=[];
                data_in{1,ll}.regressor{1,56}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: zrpe H'};
                
                data_in{1,ll}.regressor{1,57}.name='REWARD_HISTORY';    data_in{1,ll}.regressor{1,57}.value=[];
                data_in{1,ll}.regressor{1,57}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: reward_history'};
                data_in{1,ll}.regressor{1,58}.name='choice_history';    data_in{1,ll}.regressor{1,58}.value=[];
                data_in{1,ll}.regressor{1,58}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: choice -1: left, 1: right'};
                data_in{1,ll}.regressor{1,59}.name='response_latency';    data_in{1,ll}.regressor{1,59}.value=[];
                data_in{1,ll}.regressor{1,59}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: response latency'};
                    ...
                    while (((myArbitrator_top.ind_active_model==1)&&(~map.JobComplete))||((myArbitrator_top.ind_active_model==2)&&(~map.JobComplete)))
                        ...
                        if(mode.out==99) % regressors
                            if(map.index==1) % only for the *first state*
                                ...
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model;  mean(abs(myArbitrator_top.zrpe))]; % session; block; trial; trial_s; goal; active_model; x
...
%                             disp(state_sarsa.RPE_history');
                        ...
                        if(mode.out==99) % regressors
                            ...
                            %                             if(an_j==2)
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; mean(abs(myArbitrator_top.zrpe))]; % session; block; trial; trial_s; goal; active_model; x
%                             disp((mean(myArbitrator_top.zrpe)));
                            %                             else % no PMF computation because there is no need for value computation
                            %                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; 0]; % session; block; trial; trial_s; goal; active_model; x
                            %                             end
                            data_in{1,ll}.regressor{1,30}.value=[data_in{1,ll}.regressor{1,30}.value vec_reg];
                            ...
                            % regressor32 - zrpe
                            an_j=myArbitrator_top.index+1;
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; prev_zrpe-mean(abs(myArbitrator_top.zrpe))]; % session; block; trial; trial_s; goal; active_model; x
                            ...
                            % regressor49
                            an_j=myArbitrator_top.index+1;
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; var(abs(myArbitrator_top.zrpe))]; % session; block; trial; trial_s; goal; active_model; x
                            data_in{1,ll}.regressor{1,49}.value=[data_in{1,ll}.regressor{1,49}.value vec_reg];
                        end
    ...
    if(mode.out==99) % regressors
        for ll=1:1:tot_num_sbj % each subject
            ...
            mt_min1=min(data_in{1,ll}.regressor{1,29}.value(7,:));   mt_max1=max(data_in{1,ll}.regressor{1,29}.value(7,:)); 
            mt_min2=min(data_in{1,ll}.regressor{1,30}.value(7,:));   mt_max2=max(data_in{1,ll}.regressor{1,30}.value(7,:));
            if mt_max1 == mt_min1 
                mt_max1 = 1;
                mt_min1 = 0;
            end
            ...
            mbmot = (data_in{1,ll}.regressor{1,29}.value(7,:)-mt_min1)/(mt_max1-mt_min1); %[0,1]
            mfmot = (data_in{1,ll}.regressor{1,30}.value(7,:)-mt_min2)/(mt_max2-mt_min2); %[0,1]
%             mbmot = data_in{1,ll}.regressor{1,29}.value(7,:);
%             mbmot = mbmot - mean(mbmot);
%             mfmot = mfmot - mean(mfmot);
            data_in{1,ll}.regressor{1,50}.value = data_in{1,ll}.regressor{1,29}.value;
            data_in{1,ll}.regressor{1,50}.value(7,:) = mean([mbmot;mfmot]);
%             data_in{1,ll}.regressor{1,50}.value(7,:) = mbmot-mfmot;
            ...
            first_idx = 1:3:lens_;
            second_idx = 2:3:lens_;
            third_idx = 3:3:lens_;
            twothired = sort([second_idx, third_idx]);
            ...
            data_in{1,ll}.regressor{1,30}.value(7,:) = mfmot;
            ...
            data_in{1,ll}.regressor{1,50}.value(7,1:3:lens_) = zeros(1,lens_/3);
            
            data_in{1,ll}.regressor{1,51}.value = data_in{1,ll}.regressor{1,29}.value;
            data_in{1,ll}.regressor{1,52}.value = data_in{1,ll}.regressor{1,30}.value;
            data_in{1, 1}.regressor{1, 53}.value = data_in{1,ll}.regressor{1,29}.value;
            data_in{1, 1}.regressor{1, 54}.value = data_in{1,ll}.regressor{1,29}.value;
            data_in{1, 1}.regressor{1, 55}.value = data_in{1,ll}.regressor{1,30}.value;
            data_in{1, 1}.regressor{1, 56}.value = data_in{1,ll}.regressor{1,30}.value;
            
%             data_in{1,ll}.regressor{1,51}.value(7,:) = (double(logical(mbmot>=median(mbmot(twothired))))-0.5)*2;
%             data_in{1,ll}.regressor{1,52}.value(7,:) = (double(logical(mfmot>=median(mfmot(twothired))))-0.5)*2;
             
            data_in{1,ll}.regressor{1,51}.value(7,:) = zeros(size(data_in{1,ll}.regressor{1,51}.value(7,:)));
            data_in{1,ll}.regressor{1,52}.value(7,:) = zeros(size(data_in{1,ll}.regressor{1,52}.value(7,:)));
            
            
%             data_in{1,ll}.regressor{1,51}.value(7,intersect(find(mbmot>prctile(mbmot(twothired),66)),twothired)) = 1;
%             data_in{1,ll}.regressor{1,51}.value(7,intersect(find(mbmot<=prctile(mbmot(twothired),33)),twothired)) = -1;
            
%             data_in{1,ll}.regressor{1,52}.value(7,intersect(find(mfmot>prctile(mfmot(twothired),66)),twothired)) = 1;
%             data_in{1,ll}.regressor{1,52}.value(7,intersect(find(mfmot<=prctile(mfmot(twothired),33)),twothired)) = -1;
            
            data_in{1,ll}.regressor{1,51}.value(7,intersect(find(mbmot>=prctile(mbmot(twothired),50)),twothired)) = 1;
            data_in{1,ll}.regressor{1,51}.value(7,intersect(find(mbmot<prctile(mbmot(twothired),50)),twothired)) = -1;
            
            data_in{1,ll}.regressor{1,52}.value(7,intersect(find(mfmot>=prctile(mfmot(twothired),50)),twothired)) = 1;
            data_in{1,ll}.regressor{1,52}.value(7,intersect(find(mfmot<prctile(mfmot(twothired),50)),twothired)) = -1;
            
            % if the inner session trials has no difference (no contrast,
            % then make differences in the session
            for seii = unique(data_in{1, 1}.regressor{1, 51}.value(1,:))
                testbench = data_in{1, 1}.regressor{1, 51}.value(7,find(data_in{1, 1}.regressor{1, 51}.value(1,:) == seii));
                if length(unique(testbench)) ~= 3
                    mfmot_temporal = mfmot(intersect(find(data_in{1, 1}.regressor{1, 51}.value(1,:) == seii), twothired));
                    idx_larger = intersect(find(mfmot>=prctile(mfmot_temporal,50)), intersect(find(data_in{1, 1}.regressor{1, 51}.value(1,:) == seii),twothired));
                    idx_smaller = intersect(find(mfmot<prctile(mfmot_temporal,50)), intersect(find(data_in{1, 1}.regressor{1, 51}.value(1,:) == seii),twothired));
                    data_in{1, 1}.regressor{1, 51}.value(7,idx_larger)  = 1;
                    data_in{1, 1}.regressor{1, 51}.value(7,idx_smaller) = -1;
                end
            end
            
            for seii = unique(data_in{1, 1}.regressor{1, 52}.value(1,:))
                testbench = data_in{1, 1}.regressor{1, 52}.value(7,find(data_in{1, 1}.regressor{1, 52}.value(1,:) == seii));
                if length(unique(testbench)) ~= 3
                    mbmot_temporal = mbmot(intersect(find(data_in{1, 1}.regressor{1, 52}.value(1,:) == seii), twothired));
                    idx_larger = intersect(find(mbmot>=prctile(mbmot_temporal,50)), intersect(find(data_in{1, 1}.regressor{1, 52}.value(1,:) == seii),twothired));
                    idx_smaller = intersect(find(mbmot<prctile(mbmot_temporal,50)), intersect(find(data_in{1, 1}.regressor{1, 52}.value(1,:) == seii),twothired));
                    data_in{1, 1}.regressor{1, 52}.value(7,idx_larger)  = 1;
                    data_in{1, 1}.regressor{1, 52}.value(7,idx_smaller) = -1;
                end
            end
            data_in{1, 1}.regressor{1, 53}.value(7,:) = zeros(size(data_in{1, 1}.regressor{1, 53}.value(7,:)));
            data_in{1, 1}.regressor{1, 54}.value(7,:) = zeros(size(data_in{1, 1}.regressor{1, 54}.value(7,:)));
            data_in{1, 1}.regressor{1, 55}.value(7,:) = zeros(size(data_in{1, 1}.regressor{1, 55}.value(7,:)));
            data_in{1, 1}.regressor{1, 56}.value(7,:) = zeros(size(data_in{1, 1}.regressor{1, 56}.value(7,:)));
            
            data_in{1, 1}.regressor{1, 53}.value(7,find(data_in{1, 1}.regressor{1, 51}.value(7,:) == -1)) = 1;
            data_in{1, 1}.regressor{1, 54}.value(7,find(data_in{1, 1}.regressor{1, 51}.value(7,:) == 1)) = 1;
            
            data_in{1, 1}.regressor{1, 55}.value(7,find(data_in{1, 1}.regressor{1, 52}.value(7,:) == -1)) = 1;
            data_in{1, 1}.regressor{1, 56}.value(7,find(data_in{1, 1}.regressor{1, 52}.value(7,:) == 1)) = 1;
            

            maxsess = size(data_in{1,ll}.HIST_block_condition,2);
            dat = [];
            for si = 1 : 1 : maxsess
                dat = [dat; data_in{1,ll}.HIST_behavior_info{1,si}];
            end
            
            rewards = [];
            for isdf = 1:1:length(dat)
                rewards = [rewards 0];
                rewards = [rewards 0];
                rewards = [rewards dat(isdf,16)];
            end
            
            actions = [];
            for isdf = 1:1:length(dat)
                actions = [actions 0];
                actions = [actions (dat(isdf,7)-1.5)*2];
                actions = [actions (dat(isdf,8)-1.5)*2];
            end
            ...
            data_in{1, 1}.regressor{1, 57}.value = data_in{1, 1}.regressor{1, 1}.value;
            data_in{1, 1}.regressor{1, 58}.value = data_in{1, 1}.regressor{1, 1}.value;
            data_in{1, 1}.regressor{1, 59}.value = data_in{1, 1}.regressor{1, 1}.value;
            
            data_in{1, 1}.regressor{1, 57}.value(7,:) = zeros(size(data_in{1, 1}.regressor{1, 53}.value(7,:)));
            data_in{1, 1}.regressor{1, 58}.value(7,:) = zeros(size(data_in{1, 1}.regressor{1, 53}.value(7,:)));
            data_in{1, 1}.regressor{1, 59}.value(7,:) = zeros(size(data_in{1, 1}.regressor{1, 53}.value(7,:)));
            
            data_in{1, 1}.regressor{1, 57}.value(7,:) = rewards;
            data_in{1, 1}.regressor{1, 58}.value(7,:) = actions;
            data_in{1, 1}.regressor{1, 59}.value(7,:) = rts;
...
%             data_in{1,ll}.regressor{1,51}.value(7,1:3:lens_) = zeros(1,lens_/3);
%             data_in{1,ll}.regressor{1,52}.value(7,1:3:lens_) = zeros(1,lens_/3);
%             data_in{1,ll}.regressor{1,30}.value(7,:) = data_in{1,ll}.regressor{1,30}.value(7,:)- mean(data_in{1,ll}.regressor{1,30}.value(7,:));
%             data_in{1,ll}.regressor{1,30}.value(7,3:3:lens_) = zeros(1,lens_/3);
%             data_in{1,ll}.regressor{1,42}.value(7,1:3:lens_) = zeros(1,lens_/3); 
        end
    end
