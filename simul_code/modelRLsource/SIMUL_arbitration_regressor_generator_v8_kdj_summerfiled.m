...
param_regressor_type_cue={'SPE', 'RPE','uncertaintyM2','MAXinvFano12','Qsarsa','Qfwd','Qarb'};
param_regressor_type_cue={'RPE', 'uncertaintyM2','MAXinvFano12','Qsarsa','Qfwd','Qarb'};
...
if(Do_create_regressors==1)
    ...
    for jj2=1:1:size(SBJ,2)        % each subject
        ...
        switch  PE_CASE
            case 0 % use the original SPE and RPE
            case 1 % baseline SPE only
                SBJ{1,jj2}.regressor{1, 1}.value(7,:) = SBJ{1,jj2}.regressor{1, 29}.value(7,:);
            case 2 % baseline RPE only
                SBJ{1,jj2}.regressor{1, 2}.value(7,:) = abs(SBJ{1,jj2}.regressor{1, 30}.value(7,:));
            case 3
                SBJ{1,jj2}.regressor{1, 1}.value(7,:) = SBJ{1,jj2}.regressor{1, 29}.value(7,:);
                SBJ{1,jj2}.regressor{1, 2}.value(7,:) = SBJ{1,jj2}.regressor{1, 30}.value(7,:);                
        end
