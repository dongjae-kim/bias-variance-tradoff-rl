...
row_mat=[7 7 8 8 8 8 8 8 7 7 7 7 7 7 7 8 8 7 7 8 8 8 8 7 8 8]; % from which row in the SBJ{}.regressor matrix the signal needs to be extracted. e.g., uncertainty of 0 prediction error
...
name_paramfile_to_test='SBJ_structure_each_exp_BESTcollection_FullBayes.mat'; 
...
%         if(isfield(SBJ0{1,1}.model_BayesArb.mode, 'boundary_12')==1) % parameter length=6 case
        ...
        if(strcmp(name_paramfile_to_test,'SBJ_structure_each_exp_BESTcollection_Daw.mat')==1)
            SBJ0=eval_ArbitrationRL3_Daw(model_BayesArb.param,SBJ0,mode); % refresh and add the regressor part  : eval_ArbitrationRL2(x, SBJ_test, mode) for full BayesArb
        else
