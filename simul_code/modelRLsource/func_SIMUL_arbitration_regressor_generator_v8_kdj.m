function func_SIMUL_arbitration_regressor_generator_v8_kdj(falg)
% clear; clc;
warning('off')
...
if falg == 0
    param_regressor_type_cue={'SPE','RPE','uncertaintyM1','MAXinvFano12', 'SPE_BL','Qfwd','Qsarsa','Qarb'};

elseif falg == 1
param_regressor_type_cue={'SPE','RPE','uncertaintyM1','invFanoM1','SPE_BL','Qsarsa','Qfwd','Qarb'};
else
param_regressor_type_cue={'SPE','RPE','uncertaintyM1','invFanoM2','SPE_BL','Qsarsa','Qfwd','Qarb'};
end
