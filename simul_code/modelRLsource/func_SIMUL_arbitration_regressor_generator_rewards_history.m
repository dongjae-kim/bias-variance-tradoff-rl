% clear; clc;
function func_SIMUL_arbitration_regressor_generator_fixed_kdj_SPEBL()
warning('off')
% in = 16;
...
TYPE_REGRESSOR=[1 1, 1.5 1.5, 1.5 1.5, 1.5 1.5, 1.5, 1.5, 1.5 1.5 1.5 1.5 1.5 1.5 1.5, 3 3 1.5 1.5 1.5 3 2 1.5 1.5 3 3 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5]; % 1: parametric modulation (0-duration), 1.5:parmetric modulation (non-zero duration), 1.7:parametric modulation (with decision onset)  2: extra continuous parametric modulation (TR-fixed) - this will be used by "dummy" regressor. 3 : IDK
...
row_mat=[7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7]; % from which row in the SBJ{}.regressor matrix the signal needs to be extracted. e.g., uncertainty of 0 prediction error
...
%         param_regressor_type_cue={'SPE','RPE','REWARD_HISTORY','choice_history','response_latency'};
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','SPE_BL','uncertaintyM1','RPE_BL','Qsarsa','Qfwd','Qarb','REWARD_HISTORY','choice_history','response_latency','dQbwdMean'};
...
%     ind_chk = [];
    ...
    if(strcmp(param_regressor_type_cue{1,ii},'REWARD_HISTORY')==1)    use_model_regressor_cue=1;    ind_chk=57;   end
    if(strcmp(param_regressor_type_cue{1,ii},'choice_history')==1)    use_model_regressor_cue=1;    ind_chk=58;   end
    if(strcmp(param_regressor_type_cue{1,ii},'response_latency')==1)    use_model_regressor_cue=1;    ind_chk=59;   end
%     if(strcmp(param_regressor_type_cue{1,ii},'SPE')==1)    use_model_regressor_cue=1;  ind_chk=1;   end
%     if(strcmp(param_regressor_type_cue{1,ii},'RPE')==1)    use_model_regressor_cue=1;  ind_chk=2;   end
