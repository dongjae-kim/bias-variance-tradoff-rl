% clear; clc;
function func_SIMUL_arbitration_regressor_generator_pebl_lh_kdj(in)
warning('off')
% in = 16;
...
LIST_REGRESSOR={'SPE', 'RPE', 'uncertaintyM1', 'uncertaintyM2', 'meanM1', 'meanM2', 'invFanoM1', 'invFanoM2', 'weigtM1', 'weigtM2', 'Qfwd', 'Qsarsa', 'Qarb', 'dQbwdEnergy', 'dQbwdMean', 'duncertaintyM1', 'dinvFanoM1', ...
    ...
    'inter_rpebl_uncer' ,'inter_rpebl_gc', 'MAXrel', 'spe_var', 'rpe_var','MOTIV','SPEBL_LH','RPEBL_LH','SPEBL_L','SPEBL_H','RPEBL_L','RPEBL_H'};
...
TYPE_REGRESSOR=[1 1, 1.5 1.5, 1.5 1.5, 1.5 1.5, 1.5, 1.5, 1.5 1.5 1.5 1.5 1.5 1.5 1.5, 3 3 1.5 1.5 1.5 3 2 1.5 1.5 3 3 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5 1.5]; % 1: parametric modulation (0-duration), 1.5:parmetric modulation (non-zero duration), 1.7:parametric modulation (with decision onset)  2: extra continuous parametric modulation (TR-fixed) - this will be used by "dummy" regressor. 3 : IDK
...
row_mat=[7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7]; % from which row in the SBJ{}.regressor matrix the signal needs to be extracted. e.g., uncertainty of 0 prediction error
...
switch in
    case 1
        param_regressor_type_cue={'SPE','RPE','RPEBL_LH'};
        reg_type_go_first=[1 1.5 2];
    case 2
        param_regressor_type_cue={'SPE','RPE','SPEBL_LH'};
        reg_type_go_first=[1 1.5 2];
    case 3
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','RPEBL_LH'};
        reg_type_go_first=[1 1.5 2];
    case 4
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','SPEBL_LH'};
        reg_type_go_first=[1 1.5 2];
    case 5
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','RPEBL_LH','uncertaintyM1','SPE_BL','Qsarsa','Qfwd','Qarb'};
        reg_type_go_first=[1 1.5 2];
    case 6
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','RPE_BL','uncertaintyM1','SPEBL_LH','Qsarsa','Qfwd','Qarb'};
        reg_type_go_first=[1 1.5 2];
    case 7
        'GURA_PING'
    case 8
        param_regressor_type_cue={'SPE','RPE','MAXinvFano12','RPE_BL','uncertaintyM1','SPEBL_LH'};
        reg_type_go_first=[1 1.5 2];
...
%     ind_chk = [];
    ...
    if(strcmp(param_regressor_type_cue{1,ii},'SPEBL_LH')==1)    use_model_regressor_cue=1;    ind_chk=51;   end
    if(strcmp(param_regressor_type_cue{1,ii},'RPEBL_LH')==1)    use_model_regressor_cue=1;    ind_chk=52;   end
    if(strcmp(param_regressor_type_cue{1,ii},'SPEBL_L')==1)    use_model_regressor_cue=1;    ind_chk=53;   end
    if(strcmp(param_regressor_type_cue{1,ii},'SPEBL_H')==1)    use_model_regressor_cue=1;    ind_chk=54;   end
    if(strcmp(param_regressor_type_cue{1,ii},'RPEBL_L')==1)    use_model_regressor_cue=1;    ind_chk=55;   end
    if(strcmp(param_regressor_type_cue{1,ii},'RPEBL_H')==1)    use_model_regressor_cue=1;    ind_chk=56;   end
%     if(strcmp(param_regressor_type_cue{1,ii},'SPE')==1)    use_model_regressor_cue=1;  ind_chk=1;   end
%     if(strcmp(param_regressor_type_cue{1,ii},'RPE')==1)    use_model_regressor_cue=1;  ind_chk=2;   end
...
sbj_best={'SBJ_Hao_DPON_2017May16_45515.mat','SBJ_Breanna_DPON_2017May13_19127.mat','SBJ_Derek_DPON_2017May15_0416.mat','SBJ_Timothy_DPON_2017Jun29_72615.mat','SBJ_Teagan_DPON_2017May14_61518.mat','SBJ_Jeffrey_DPON_2017May18_155311.mat','SBJ_Seung_DPON_2017May15_215952.mat','SBJ_Carole_DPON_2017May15_3553.mat','SBJ_Tony_DPON_2017May11_10166.mat','SBJ_Surendra_DPON_2017Jul28_21345.mat','SBJ_Lark_M5_2017Jul15_35838.mat','SBJ_Joaquin_DPON_2017May14_233724.mat','SBJ_DavidB_DPON_2017Jun9_21659.mat','SBJ_Christopher_M5_2017Jul15_5415.mat','SBJ_Gjergji_DPON_2017Aug1_4448.mat','SBJ_Charles_M5_2017Jul19_1189 - 복사본.mat','SBJ_Erin_DPON_2017May16_14731.mat','SBJ_Connor_DPON_2017May9_22365.mat','SBJ_Thao_DPON_2017May14_215451.mat','SBJ_Arin_DPON_2017May10_92924.mat','SBJ_Pauline_DPON_2017May18_123539.mat','SBJ_Tho_DPON_2017May14_35241.mat'};
