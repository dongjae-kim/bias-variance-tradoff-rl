...
function SIMUL_arbitration_regressor_generator_v8_kdj_batchfor0403(input)
warning('off')
...
TYPE_REGRESSOR=[1 1, 1.5 1.5, 1.5 1.5, 1.5 1.5, 2 2, 1.5 1.5 1.5 1.5 1.5 1.5 1.5, 3 3 3 3 1.5 3 3 3 3 3 3 1 1 1.5 1.5]; % 1: parametric modulation (0-duration), 1.5:parmetric modulation (non-zero duration), 1.7:parametric modulation (with decision onset)  2: extra continuous parametric modulation (TR-fixed) - this will be used by "dummy" regressor. 3 : IDK
...
switch input
    case 0
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','MAXinvFano12','Qsarsa','Qfwd','Qarb', 'dspebl', 'drpebl'};
    case 1
        param_regressor_type_cue={'SPE','SPE_BL','RPE','uncertaintyM1','MAXinvFano12','Qsarsa','Qfwd','Qarb', 'dspebl', 'drpebl'};
    case 2
        param_regressor_type_cue={'SPE','SPE_BL','RPE','uncertaintyM1','uncertaintyM2','MAXinvFano12','Qsarsa','Qfwd','Qarb', 'dspebl', 'drpebl'};
    case 3
        param_regressor_type_cue={'SPE','RPE','uncertaintyM1','uncertaintyM2','MAXinvFano12','Qsarsa','Qfwd','Qarb', 'dspebl', 'drpebl'};
end
