...
%                 disp(sprintf('- generating regressor for SBJ%02d/%02d...',ll,tot_num_sbj));
                ...
                data_in{1,ll}.regressor{1,31}.name='SPE_z';    data_in{1,ll}.regressor{1,31}.value=[];
                data_in{1,ll}.regressor{1,31}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: zspe'};
                data_in{1,ll}.regressor{1,32}.name='RPE_z';    data_in{1,ll}.regressor{1,32}.value=[];
                data_in{1,ll}.regressor{1,32}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: zrpe'};                
...
%                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; myArbitrator_top.Q(state_data,action_chosen)]; % session; block; trial; trial_s; goal; active_model; x                                
                            ...
                            an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; sum(myArbitrator_top.m1_mean.* myArbitrator_top.m1_wgt);]; % session; block; trial; trial_s; goal; active_model; x
                            data_in{1,ll}.regressor{1,29}.value=[data_in{1,ll}.regressor{1,29}.value vec_reg];
...
%                             % regressor31 - zspe
%                             an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
%                             if myArbitrator_top.z_spe_flag == 1
%                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; state_fwd.SPE_history(map.index)]; % session; block; trial; trial_s; goal; active_model; SPE
%                             else
%                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; 0]; % session; block; trial; trial_s; goal; active_model; SPE    
%                             end
%                             data_in{1,ll}.regressor{1,31}.value=[data_in{1,ll}.regressor{1,29}.value vec_reg];
%                             
%                             % regressor32 - zrpe
%                             an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
%                             if myArbitrator_top.z_rpe_flag == 1
%                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; state_fwd.RPE_history(map.index)]; % session; block; trial; trial_s; goal; active_model; SPE
%                             else
%                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; 0]; % session; block; trial; trial_s; goal; active_model; SPE    
%                             end
%                             data_in{1,ll}.regressor{1,32}.value=[data_in{1,ll}.regressor{1,30}.value vec_reg];
                        end
