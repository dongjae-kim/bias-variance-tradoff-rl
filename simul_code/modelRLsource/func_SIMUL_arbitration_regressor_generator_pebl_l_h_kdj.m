% clear; clc;
function func_SIMUL_arbitration_regressor_generator_pebl_l_h_kdj(in)
warning('off')
% in = 16;
...
switch in
    case 1
        param_regressor_type_cue={'SPE','RPE','SPEBL_L'};
        reg_type_go_first=[1 1.5 2];
    case 2
        param_regressor_type_cue={'SPE','RPE','SPEBL_H'};
        reg_type_go_first=[1 1.5 2];
    case 3
        param_regressor_type_cue={'SPE','RPE','RPEBL_L'};
        reg_type_go_first=[1 1.5 2];
    case 4
        param_regressor_type_cue={'SPE','RPE','RPEBL_H'};
        reg_type_go_first=[1 1.5 2];
