function [data_out] = eval_ArbitrationRL_DPON(param_in, data_in, mode)
...
PE = Init_PE(data_in,param_in,mode);
MODELS=Init_DirichletProcessNormalMix_Arbitration_Init(PE,mode.alpha);
data_in{1,1}.DPNMM_MODEL = MODELS;
data_in{1,1}.RPE_sarsa = PE.RPE_SARSA;
