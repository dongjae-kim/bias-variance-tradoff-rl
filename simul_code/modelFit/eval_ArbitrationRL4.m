function [data_out] = eval_ArbitrationRL4(param_in, data_in, mode)
...
%             param_fwd.alpha=param_fwd.alpha/0.5;
            ...
            for ind_sess=1:1:num_max_session
                ...
                while ((i<num_max_trial)&&(cond))
                    ...
                    mode_data=map.data(map.trial,18:20); % 원래 18열 까지밖에 없는게 HIST_behavior인데.. 대체 뭘 추가했길래?
...
%                         [myArbitrator_top, state_fwd, state_sarsa]=Bayesian_Arbitration_v3(myArbitrator_top, state_fwd, state_sarsa, map); % full bayesian 
                        [myArbitrator_top, state_fwd, state_sarsa]=Bayesian_Arbitration_v6(myArbitrator_top, state_fwd, state_sarsa, map); % bayesian for m1, RPE estimator for m2 + cogload
