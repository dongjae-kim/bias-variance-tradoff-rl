function [data_out] = eval_ArbitrationRL_IGMM_ONLINE(param_in, data_in, mode)
...
myArbitrator=BEBP_Arbitration_model_Init(N_state,N_action,N_transition, myMap, data_in);
...
%                         [myArbitrator_top, state_fwd, state_sarsa]=Bayesian_Arbitration_v4(myArbitrator_top, state_fwd, state_sarsa, map); % bayesian for m1, RPE estimator for m2
                        [myArbitrator_top, state_fwd, state_sarsa]=BEBP_Arbitration_model(myArbitrator_top, state_fwd, state_sarsa, map); % full bayesian 
