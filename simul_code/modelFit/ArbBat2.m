function [SBJ]=ArbBat2(maxi,mode, PE, MODELS,PreBehav, PreBlck,MainBehav,MainBlck,list_sbj)
tt = clock;
rng(floor(tt(6)*1000));
param_init=[randi(5)  , randi(7) ,  0.05 + 0.015 * randi(100) , 0.03 + 0.012*randi(10)];
