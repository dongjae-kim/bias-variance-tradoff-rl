function [data_out] = eval_ArbitrationRL6c(param_in, data_in, mode)
...
% myArbitrator=DirichletProcessNormalMix_Arbitration_Init(N_state,N_action,N_transition,data_in);
